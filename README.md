...
На портале доступны главы 1–7 актуальной редакции, подготовка лабораторной среды, Практикум 0 и ЛР №1–5. Следующие главы и лабораторные публикуются только после прохождения соответствующих проверок курса.

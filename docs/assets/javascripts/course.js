...
function initializeMethodDemo() {
  const content = {
    ...
    behavior: {
      title: "Выполнено ли заданное условие над серией событий?",
      text: "Поведенческий метод может использовать частоту, последовательность и повторяемость с фиксированным порогом.",
      outcome: "Для такого решения не требуется заранее обучать модель нормальной активности."
    },
    anomaly: {

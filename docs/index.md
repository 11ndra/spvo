<div class="home-hero">
  ...
  <p class="home-hero-lead">
    ...
    и как сохранять подтверждённые возможности обнаружения после изменений системы.
  </p>
...
Маршрут читается сверху вниз. Главы 1–8 формируют базовое инженерное ядро; Главы 9–10 развивают его в сторону современных протоколов, наблюдаемости и эксплуатации. Лабораторные закрепляют уже введённые понятия и пока не расширяются новыми работами.

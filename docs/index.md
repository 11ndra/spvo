...
<div class="home-final-cta">
  ...
  <h2>Последовательно пройдите Главы 1–4 и закрепите ключевые идеи первыми тремя лабораторными экспериментами.</h2>
  <div class="home-actions">

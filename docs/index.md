...
Маршрут читается сверху вниз. Главы 1–8 формируют базовое инженерное ядро; Главы 9–11 развивают его в сторону современных протоколов, эксплуатации и доказательного сопоставления нескольких источников. Лабораторные закрепляют уже введённые понятия и пока не расширяются новыми работами.

...
[Глава 6 — Что такое правила и как они устроены](course/06-rules/){ .md-button .md-button--primary }
[ЛР №5 — Первое собственное правило Suricata](labs/lab05/){ .md-button }

После ЛР №2 студент сопоставляет сетевой и хостовый след одного эпизода. Глава 3 раскрывает функциональное устройство IDS/IPS, а Глава 4 переносит эту модель в реальную топологию: где должен существовать сетевой след и через какую точку его можно получить. ЛР №3 проверяет это на двух сетевых путях. Глава 5 после этого отвечает на следующий вопрос: по какому условию наблюдаемая активность становится результатом обнаружения. ЛР №4 удерживает один формат событий и меняет только основание решения: точный признак, детерминированное условие над серией событий и отклонение от базовой линии. Глава 6 переводит сигнатурное условие в синтаксис Suricata, а ЛР №5 впервые требует от студента самостоятельно прочитать, изменить и написать простое правило, после чего проверить его положительным и отрицательным тестами.

!!! warning "Переходная версия курса"
    Главы 1–6 и ЛР №1–5 уже переведены на новую структуру. Главы 7–8, старая глава об оценке качества и предварительная проверка знаний пока сохраняются как материалы предыдущей редакции и будут заменяться последовательно.
...
<div class="home-final-cta">
  ...
  <h2>Последовательно пройдите Главы 1–6 и закрепите ключевые идеи первыми пятью лабораторными экспериментами.</h2>
  <div class="home-actions">

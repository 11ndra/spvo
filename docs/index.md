...
После ЛР №2 студент уже не просто знает определения NIDS/HIDS, а сопоставляет два независимых подтверждения одного контролируемого эпизода. Глава 3 затем раскрывает внутреннюю функциональную архитектуру IDS/IPS.

!!! warning "Переходная версия курса"
    Главы 1–3 и ЛР №1–2 уже переведены на новую структуру. Главы 4–8 и предварительная проверка знаний пока сохраняются из предыдущей редакции и будут заменяться последовательно.
...
<div class="home-final-cta">
  ...
  <h2>Последовательно пройдите Главы 1–3 и закрепите первые две темы лабораторными экспериментами.</h2>
  <div class="home-actions">

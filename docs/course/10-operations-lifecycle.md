...
Из этой главы возникает следующий инженерный вопрос: когда одного сенсора и одного результата недостаточно, **как сопоставлять независимые источники, контекст угроз и несколько результатов, не превращая корреляцию в ложную «единую истину»?** Для ответа потребуется отдельная модель нескольких источников и границ их совместного вывода.

...
<div class="next-step">
<strong>Практическое закрепление:</strong> после Главы 2 выполните <a href="../../labs/lab02/">ЛР №2</a>, чтобы сравнить сетевые и хостовые источники данных. Следующей перерабатываемой темой станет Глава 4 о размещении и архитектуре наблюдения.
</div>

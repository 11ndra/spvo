...
!!! note "Статус модели"
    Эта последовательность — **инженерная абстракция курса**, а не нормативная схема NIST и не точное описание внутреннего pipeline каждого продукта. Она согласуется с общими задачами сетевой IDPS — capture, decoding/state tracking, protocol analysis и detection — и в практической части проверяется на конкретном движке Suricata.

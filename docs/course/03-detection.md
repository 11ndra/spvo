...
В фундаментальной работе **Thomas Ptacek и Timothy Newsham, _Insertion, Evasion, and Denial of Service: Eluding Network Intrusion Detection_**, исследователи проверяли способы обмана сетевых IDS через особенности IP/TCP-обработки. Среди рассматриваемых проблем были фрагментация, неоднозначности обработки пакетов, порядок TCP-сегментов и восстановление потока.

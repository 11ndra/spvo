...
<div class="next-step">
<strong>Следующий шаг:</strong> после Главы 2 выполните <a href="../../labs/lab02/">ЛР №2</a>, чтобы сравнить сетевые и хостовые источники данных. Затем переходите к <a href="../04-detection-methods/">Главе 4</a>: там функциональная модель связывается с физической сетью и появляется вопрос, <strong>в какой точке сенсор вообще может получить нужный трафик</strong>.
</div>

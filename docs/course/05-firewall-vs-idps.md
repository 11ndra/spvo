...
<div class="next-step">
<strong>Дальше:</strong> даже правильный механизм detection способен ошибаться. Разберём <a href="../06-detection-quality/">True/False Positives и False Negatives</a>.
</div>

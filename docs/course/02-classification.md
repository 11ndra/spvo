...
Эти два вывода напрямую подготавливают ЛР №2: один контролируемый эпизод будет одновременно наблюдаться сетевым и хостовым источником, чтобы сравнение было основано на собственных доказательствах студента.
...
<div class="next-step">
<strong>Сначала закрепите тему:</strong> выполните <a href="../../labs/lab02/">ЛР №2 — «Сетевой и хостовый взгляд»</a>. Затем переходите к <a href="../03-detection/">Главе 3</a>, где разберём функциональное устройство IDS/IPS.
</div>

...
<div class="concept-formula primary-formula">
  ...
  <span class="formula-right">РАЗНЫЕ ИСТОЧНИКИ</span>
  <p>Тип IDS/IPS определяет прежде всего область и источник наблюдения, а не «уровень качества» системы.</p>
</div>
...
<div class="source-choice-grid">
  <article><span>Изменение критичного файла</span><strong>Хостовый источник</strong><p>События файловой системы / контроль целостности → HIDS.</p></article>
  <article><span>Внутреннее сетевое сканирование</span><strong>Сетевой источник</strong><p>Множество сетевых взаимодействий → NIDS или анализ потоков.</p></article>
  <article><span>Неизвестная точка Wi‑Fi</span><strong>Беспроводной источник</strong><p>Радиообмен и 802.11 → WIDS.</p></article>
</div>
...
<div class="axiom-grid">
  <article class="axiom-card"><span>01</span><strong>СЕТЕВОЙ ВЗГЛЯД ≠ ХОСТОВЫЙ ВЗГЛЯД</strong><p>Один эпизод оставляет разные следы в разных средах.</p></article>
  <article class="axiom-card"><span>02</span><strong>БЕСПРОВОДНАЯ ВИДИМОСТЬ ≠ ПРОВОДНАЯ ВИДИМОСТЬ</strong><p>Наблюдение IP-трафика не заменяет наблюдение радиообмена.</p></article>
  <article class="axiom-card"><span>03</span><strong>ИСТОЧНИК ДАННЫХ ≠ МЕТОД ОБНАРУЖЕНИЯ</strong><p>То, откуда пришли данные, и то, как принято решение, — разные оси.</p></article>
  <article class="axiom-card"><span>04</span><strong>ОДИН СЕНСОР ≠ ПОЛНАЯ НАБЛЮДАЕМОСТЬ</strong><p>Область наблюдения всегда ограничена доступными источниками и конфигурацией.</p></article>
</div>
...
- Application-Based IDPS в NIST рассматривается как разновидность host-based monitoring для конкретного прикладного сервиса.

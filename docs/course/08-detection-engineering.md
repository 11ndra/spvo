...
!!! note "Проверено по Suricata 8"
    На дату source audit (09.09.2026) текущая стабильная ветка Suricata — **8.0.6**. Официальная документация Suricata 8 описывает `http.uri` как нормализованный URI buffer, а `http.uri.raw` — как raw URI buffer.

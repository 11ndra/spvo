...
Связь с силлабусом: итоговая тема подготовки специалиста и проектные темы по false positives, HTTPS, производительности, обнаружению сканирования, сетевым аномалиям, real-time detection и эффективности правил сведены к единой методике оценки с явными scope, evidence и границами вывода.

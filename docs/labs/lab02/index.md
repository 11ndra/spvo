...
Перед началом должны быть изучены [Глава 2](../../course/02-classification/) и [Глава 3](../../course/03-detection/): в этой работе студент уже использует два источника данных и должен понимать место источника, обработки и результата в функциональной модели IDS/IPS.
